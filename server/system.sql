...
INSERT INTO Officer (Username, User_password) VALUES 
	('McNulty', 'plod123'),
	('Moreland', 'fuzz42'),
	('xiaohuang','xiaxia'),
	('Daniels', 'copper99');
...
INSERT INTO People (People_ID, People_name, People_DOB, People_address, People_licence) VALUES
(1,'James Smith', '1979-06-05','23 Barnsdale Road, Leicester', 'SMITH92LDOFJJ829'),
(2,'Jennifer Allen', '1965-01-01', '46 Bramcote Drive, Nottingham', 'ALLEN88K23KLR9B3'),
(3,'John Myers', '1999-06-21', '323 Derby Road, Nottingham', 'MYERS99JDW8REWL3'),
(4,'James Smith', '1971-03-30', '26 Devonshire Avenue, Nottingham', 'SMITHR004JFS20TR'),
(5,'Terry Brown', '1970-11-01', '7 Clarke Rd, Nottingham', 'BROWND3PJJ39DLFG'),
(6,'Mary Adams', '1988-02-21', '38 Thurman St, Nottingham', 'ADAMSH9O3JRHH107'),
(7,'Neil Becker', '1992-04-12', '6 Fairfax Close, Nottingham', 'BECKE88UPR840F9R'),
(8,'Angela Smith', '1998-09-10', '30 Avenue Road, Grantham', 'SMITH222LE9FJ5DS'),
(9,'Xene Medora', '1991-12-21', '22 House Drive, West Bridgford', 'MEDORH914ANBB223');
...
CREATE TABLE Vehicle (
  ...
  Vehicle_licence varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(19,'Nissan', 'Pulsar', 'Red', 'NY64KWD'),
(20,'Renault', 'Scenic', 'Silver', 'BC16OEA'),
(21,'Hyundai', 'i30', 'Grey', 'AD223NG');
